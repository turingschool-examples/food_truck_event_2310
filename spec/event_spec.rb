...
RSpec.describe Event do
  ...
  describe '#all_items_all_trucks' do
    it 'returns an alphabetical list of all items from all trucks without duplicates' do
      event = Event.new("South Pearl Street Farmers Market")
      food_truck1 = FoodTruck.new("Rocky Mountain Pies")
      food_truck2 = FoodTruck.new("Ba-Nom-a-Nom")
      food_truck3 = FoodTruck.new("Palisade Peach Shack")
  ...
  describe "#items_available_global" do
    it "returns a Hash of all inventory of all truck items amd a list of trucks that sell them" do
      event = Event.new("South Pearl Street Farmers Market")
      food_truck1 = FoodTruck.new("Rocky Mountain Pies")
      food_truck2 = FoodTruck.new("Ba-Nom-a-Nom")
      food_truck3 = FoodTruck.new("Palisade Peach Shack")
